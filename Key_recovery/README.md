...
Đây là link mình tham khảo: [OpenSSH format](https://coolaj86.com/articles/openssh-vs-openssl-key-formats/)
...
print(f'Pay me 1000 BTC to recover your corrupted private key at {COR}')
 ```
Sau khi đọc file ransom thì mình thấy các byte từ 1262-1452, 1458-1651, 1655-1848 bị thay bằng null. Đó có vẻ là các bytes của private key, tuy nhiên các bytes của public key nằm ở đầu nên ta có thể recover được. 
